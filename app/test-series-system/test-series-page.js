...
const GOOGLE_FORM_CONVERSION = "AW-16812620227/5sYTCKy4mfQZEMPz8NA-";
const GOOGLE_WHATSAPP_CONVERSION = "AW-16812620227/X5haCPyz3qccEMPz8NA-";
...
function fireWhatsAppConversion() {
  if (typeof window !== "undefined" && window.gtag) {
    window.gtag("event", "conversion", { send_to: GOOGLE_WHATSAPP_CONVERSION });
  }
}
